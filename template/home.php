<form class="mb-4">
    ...
    <small class="form-text text-muted mb-1">Un accueil de scoutisme regroupe au moins 7 mineurs.</small>
...
<p class="card-text">
    ...
    href="http://www.scoutisme-francais.fr/formation" target="_blank">
    Guide Réglementaire du Scoutisme Français - Édition du 5 février 2020
    </a>
</p>
